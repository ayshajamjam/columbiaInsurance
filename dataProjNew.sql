...
VALUES ('Timsi', 'Muttreja', 'Optometrist', 'OD','Dr. Timsi Muttreja is a compassionate optometrist driven to provide exceptional care to her patients in New York. Dr. Muttreja earned her Bachelor''s degree in Chemistry from SUNY Oswego. She received her Doctorate of Optometry from IAUPR School of Optometry, where she received the Award for Clinical Excellence. Dr. Muttreja provides comprehensive eye examinations and manages various ocular diseases including, but not limited to, dry eyes, cataracts, glaucoma and corneal related problems. She is fluent in Hindi, Punjabi, and Spanish. In her free time, Dr. Muttreja enjoys traveling, art and spending time with her family',
 ...
 ARRAY ['dry eyes', 'cataracts', 'glaucoma', 'Annual Eye Exam', 'Contact Lenses', 'Eye Infection', 'General Eye Consultation']);
...
ARRAY ['Back Pain', 'Headache', 'Migraine', 'Neurology Consultation', 'Sleep Problems', 'Neuromuscular Disorders', 'Spasticity Management']);
...
ARRAY ['Pap smear irregularities', 'annual check ups', 'pre and post- menopausal symptoms', 'obstetrics', 'gynecology']);
...
ARRAY ['benign prostatic hyperplasia', 'erectile dysfunction', 'low testosterone', 'vasectomy', 'Incontinence', 'Sexually Transmitted Disease (STD)', 'Urinary Tract Infection (UTI)']);
...
ARRAY ['Cartilage Repair', 'Joint preservation', 'Arthroscopy of the shoulder, elbow, knee and ankle', 'ACL and ligament injuries of the knee', 'Cartilage repair and joint preservation', 'Cartilage transplantation', 'Meniscal tears', 'Meniscal transplantation', 'Shoulder instability and labral tears', 'Rotator cuff tears']);
...
ARRAY ['Acne', 'Allergy Consultation', 'Annual Skin Screening', 'Dermatology Consultation', 'Sexually Transmitted Disease (STD)', 'laser skin resurfacing and rejuvenation', 'body contouring', 'skin tightening', 'injectables', 'laser hair removal', 'vein treatments', 'hair loss treatments', 'personalized skin care']);
...
ARRAY ['face-lifts', 'nose reshaping', 'eyelid surgery', 'chronic sinusitis', 'nasal congestion', 'deviated septum', 'nasal polyps', 'turbinate hypertrophy', 'chronic rhinitis']);
...
ARRAY ['Anxiety', 'Depression', 'Hyperactive Disorder (ADD, ADHD)', 'Prescription and Refill', 'Psychiatry Consultation']);
...
ARRAY ['Vascular Interpretations (RPVI)', 'aortic aneurysm', 'venous insufficiency', 'varicose veins', 'peripheral arterial disease']);
...
ARRAY ['Infectious Disease Allergy', 'Immunology', 'Pediatric Allergy', 'allergy', 'asthma', 'common variable immunodeficiency', 'hives', 'hay fever']);
